[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=ubl-analytics_analytics&metric=alert_status)](https://sonarcloud.io/dashboard?id=ubl-analytics_analytics)
